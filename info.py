...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1999566732,1999566732').split()] # Replace with the actual admin ID(s) to add
...
# ============================
MOVIE_UPDATE_NOTIFICATION = bool(environ.get('MOVIE_UPDATE_NOTIFICATION', Ture))  # Notification On (True) / Off (False)
