...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1999566732,7156161923').split()] # Replace with the actual admin ID(s) to add
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1003833445589'))  # Bin channel id (make sure bot is admin)
